...
var joystick: GodotStickCircle = GodotStickCircle.new(joystick_start_position, joystick_radius, joystick_border_widht, false, joystick_color, joystick_opacity)
var stick: GodotStickCircle = GodotStickCircle.new(stick_start_position, stick_radius, stick_border_width, true, stick_color, stick_opacity)
